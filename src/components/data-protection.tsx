    ...
    return (
        <div className='max-w-[850px] mx-auto bg-slate-100 rounded-[32px] pb-4 pr-4 data-protection'>
            <div className=' mx-auto p-4 pr-0 md:p-8 flex justify-between item-center'>
                ...
                <RxCross2 size={26} className="mt-2 cursor-pointer" onClick={()=>setOpenModel(false)}/>
            </div>
            <div className='w-full h-[1px] bg-[#DDDDDD] mb-4'></div>
            <div className=' max-w-[850px] mx-auto h-[600px] overflow-y-scroll p-4 md:p-16 md:mr-6 pscroll font-light leading-7'>
                <h3 className='text-xl font-semibold mb-3'>
                    Anschrift
                </h3>
                <p>
                    BK Design GmbH<br></br>Bachweg 24<br></br>CH-7430 Thusis<br/><br/>UID: CHE-242.347.462
                </p>
                <h3 className='text-xl font-semibold mb-5 mt-8'>
                    Gründer und Geschäftsführer
                </h3>
                <p>
                    Herr<br></br>Benjamin Patt <br></br>Bachweg 24 <br></br>CH-7430 Thusis <br></br>bpa@bk-design.ch
                    <br></br><br/>und<br/><br/>
                    Herr <br></br>Kevin Alihodzic <br></br>Caznerweg 1 <br></br>CH-7430 Thusis <br></br>kal@bk-design.ch
                </p>
                <h3 className='text-xl font-semibold mb-5 mt-8'>
                ...
                <p>
                    ...
                    BK Design GmbH<br></br>Benjamin Patt<br></br>Bachweg 24<br></br>7430 Thusis<br></br><br/>
                    Telefon: +41763207033<br></br>E-Mail: bpa@bk-design.ch<br></br>WebSite: https://www.bk-design.ch/
                </p>
                <h3 className='text-xl font-semibold mb-5 mt-8'>
                    Allgemeiner Hinweis
                </h3>
                ...
                <ul className='pl-4'>
                    <li className='list-disc my-3'>
                        <strong className='font-medium'>Einwilligung</strong> (Art. 6 Abs. 1 S. 1 lit. a. DSGVO) - Die betroffene Person hat ihre Einwilligung in die Verarbeitung der sie betreffenden personenbezogenen Daten für einen spezifischen Zweck oder mehrere bestimmte Zwecke gegeben.
                    </li>
                    <li className='list-disc my-3'>
                        <strong className='font-medium'>Vertragserfüllung und vorvertragliche Anfragen</strong> (Art. 6 Abs. 1 S. 1 lit. b. DSGVO) - Die Verarbeitung ist für die Erfüllung eines Vertrags, dessen Vertragspartei die betroffene Person ist, oder zur Durchführung vorvertraglicher Massnahmen erforderlich, die auf Anfrage der betroffenen Person erfolgen.
                    </li>
                    <li className='list-disc my-3'>
                        <strong className='font-medium'>Rechtliche Verpflichtung</strong> (Art. 6 Abs. 1 S. 1 lit. c. DSGVO) - Die Verarbeitung ist zur Erfüllung einer rechtlichen Verpflichtung erforderlich, der der Verantwortliche unterliegt.
                    </li>
                    <li className='list-disc my-3'>
                        <strong className='font-medium'>Schutz lebenswichtiger Interessen</strong> (Art. 6 Abs. 1 S. 1 lit. d. DSGVO) - Die Verarbeitung ist erforderlich, um lebenswichtige Interessen der betroffenen Person oder einer anderen natürlichen Person zu schützen.
                    </li>
                    <li className='list-disc my-3'>
                        <strong className='font-medium'>Berechtigte Interessen</strong> (Art. 6 Abs. 1 S. 1 lit. f. DSGVO) - Die Verarbeitung ist zur Wahrung der berechtigten Interessen des Verantwortlichen oder eines Dritten erforderlich, sofern nicht die Interessen oder Grundrechte und Grundfreiheiten der betroffenen Person, die den Schutz personenbezogener Daten erfordern, überwiegen.
                    </li>
                    <li className='list-disc my-3'>
                        <strong className='font-medium'>Bewerbungsverfahren als vorvertragliches bzw. vertragliches Verhältnis</strong> (Art. 9 Abs. 2 lit. b DSGVO) - Soweit im Rahmen des Bewerbungsverfahrens besondere Kategorien von personenbezogenen Daten im Sinne des Art. 9 Abs. 1 DSGVO (z.B. Gesundheitsdaten, wie Schwerbehinderteneigenschaft oder ethnische Herkunft) bei Bewerbern angefragt werden, damit der Verantwortliche oder die betroffene Person die ihm bzw. ihr aus dem Arbeitsrecht und dem Recht der sozialen Sicherheit und des Sozialschutzes erwachsenden Rechte ausüben und seinen bzw. ihren diesbezüglichen Pflichten nachkommen kann, erfolgt deren Verarbeitung nach Art. 9 Abs. 2 lit. b. DSGVO, im Fall des Schutzes lebenswichtiger Interessen der Bewerber oder anderer Personen gem. Art. 9 Abs. 2 lit. c. DSGVO oder für Zwecke der Gesundheitsvorsorge oder der Arbeitsmedizin, für die Beurteilung der Arbeitsfähigkeit des Beschäftigten, für die medizinische Diagnostik, die Versorgung oder Behandlung im Gesundheits- oder Sozialbereich oder für die Verwaltung von Systemen und Diensten im Gesundheits- oder Sozialbereich gem. Art. 9 Abs. 2 lit. h. DSGVO. Im Fall einer auf freiwilliger Einwilligung beruhenden Mitteilung von besonderen Kategorien von Daten, erfolgt deren Verarbeitung auf Grundlage von Art. 9 Abs. 2 lit. a. DSGVO.
                    </li>
                </ul>
                <p>
                ...
                <ul className='pl-4'>
                    <li className='list-disc my-3'>
                        <strong className='font-medium'>Temporäre Cookies</strong> (auch: Session- oder Sitzungs-Cookies): Temporäre Cookies werden spätestens gelöscht, nachdem ein Nutzer ein Online-Angebot verlassen und seinen Browser geschlossen hat.
                    </li>
                    <li className='list-disc my-3'>
                        <strong className='font-medium'>Permanente Cookies:</strong> Permanente Cookies bleiben auch nach dem Schliessen des Browsers gespeichert. So kann beispielsweise der Login-Status gespeichert oder bevorzugte Inhalte direkt angezeigt werden, wenn der Nutzer eine Website erneut besucht. Ebenso können die Interessen von Nutzern, die zur Reichweitenmessung oder zu Marketingzwecken verwendet werden, in einem solchen Cookie gespeichert werden.
                    </li>
                    <li className='list-disc my-3'>
                    <strong className='font-medium'>First-Party-Cookies</strong> First-Party-Cookies werden von uns selbst gesetzt.
                    </li>
                    <li className='list-disc my-3'>
                    <strong className='font-medium'>Third-Party-Cookies</strong> (auch: Drittanbieter-Cookies): Drittanbieter-Cookies werden hauptsächlich von Werbetreibenden (sog. Dritten) verwendet, um Benutzerinformationen zu verarbeiten.
                    </li>
                    <li className='list-disc my-3'>
                    <strong className='font-medium'>Notwendige</strong> (auch: essenzielle oder unbedingt erforderliche) Cookies: Cookies können zum einen für den Betrieb einer Webseite unbedingt erforderlich sein (z.B. um Logins oder andere Nutzereingaben zu speichern oder aus Gründen der Sicherheit).
                    </li>
                    <li className='list-disc my-3'>
                    <strong className='font-medium'>Statistik-, Marketing- und Personalisierung-Cookies:</strong> Ferner werden Cookies im Regelfall auch im Rahmen der Reichweitenmessung eingesetzt sowie dann, wenn die Interessen eines Nutzers oder sein Verhalten (z.B. Betrachten bestimmter Inhalte, Nutzen von Funktionen etc.) auf einzelnen Webseiten in einem Nutzerprofil gespeichert werden. Solche Profile dienen dazu, den Nutzern z.B. Inhalte anzuzeigen, die ihren potenziellen Interessen entsprechen. Dieses Verfahren wird auch als "Tracking", d.h., Nachverfolgung der potenziellen Interessen der Nutzer bezeichnet. Soweit wir Cookies oder "Tracking"-Technologien einsetzen, informieren wir Sie gesondert in unserer Datenschutzerklärung oder im Rahmen der Einholung einer Einwilligung.
                    </li>
                </ul>
                <p>
