...
function Banner() {
    ...
    return (
        <main className='main-gradient-bg'>
            <section id="home" className='relative lg:h-screen flex justify-center items-center flex-col bg-[url(/images/main-mobile-bg.png)] md:bg-[url(/images/main-mg-bg.png)] lg:container lg:mx-auto lg:bg-none bg-right bg-cover bg-no-repeat py-20 px-4 -mt-[77px]'>
