...
function Banner() {
    return (
        <section className='bg-[url(/images/main.png)] bg-center bg-cover bg-no-repeat py-32 '>
            <div className='container mx-auto flex md:flex-row flex-col-reverse gap-10 px-4'>
