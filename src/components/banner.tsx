...
function Banner() {
    return (
        <section id="home" className='relative bg-[url(/images/main-mobile-bg.png)] md:bg-[url(/images/main-mg-bg.png)] lg:bg-none bg-right bg-cover bg-no-repeat py-20 px-4 -mt-[77px]'>
            ...
            <img src="/images/main-bg.png" alt="" className='absolute hidden lg:block lg:-top-40 xl:-top-20 2xl:-top-10 md:right-0 z-0 mainbg'/>
        </section>
    )
}
