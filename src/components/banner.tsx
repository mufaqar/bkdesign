...
function Banner() {
    return (
        <section id="home" className='relative bg-[url(/images/main-mobile-bg.png)] md:bg-[url(/images/main-mg-bg.png)] lg:container lg:mx-auto lg:bg-none bg-right bg-cover bg-no-repeat py-20 px-4 -mt-[77px]'>
